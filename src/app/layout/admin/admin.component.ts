...
export class AdminComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems,private loginService: LoginService,private router: Router,private cookieService: CookieService) {
    this.navType = 'st5';
...
//nIKHILD : Start Logout Methods
logoutUser(){
  console.log("i am in logoutUser  method....")
  this.loginService.logoutUser().subscribe(data =>{ this.performPostLogoutActions(data)
    },error =>{
      this.router.navigate(['dashboard']);
      alert(" Not able to Logout");}); 
}
private performPostLogoutActions(data){
  this.cookieService.delete('authObject');
  this.cookieService.delete('access_token');
  this.cookieService.delete('privilegeArray');
   this.router.navigate(['authentication']);
  alert(" You have Logout sucessfully.");
}
//nIKHILD ; End Logout Methods
