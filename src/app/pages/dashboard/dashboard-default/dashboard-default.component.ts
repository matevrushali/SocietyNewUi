...
export class DashboardDefaultComponent implements OnInit {
  ...
  helpDesk: Object;
  helpdeskOpen:Object;
  helpDeskInProgress:Object;
  helpDeskResolved:Object;
  heldeskHold:Object;
  heldeskCancelled:Object;
  ...
  constructor(private data: OccupancyService,private user: UsersFormService,private data1: ParkingService,private help: HelpdeskService,private generateBillService: GenerateBillService) { }
  ...
  ngOnInit() {
    ...
    this.data.getCountOfSoldUnsold().subscribe(
      data => this.unit = data
    );
    this.user.getCountOfOwnerTenant().subscribe(
      data => this.users = data

    );
    this.data1.getCountOfVaialParkingSlots().subscribe(
      data1 => this.
      parking = data1 
      );

      this.help.getCountOfOpenComplains().subscribe(
        data => this.helpdeskOpen = data
       );
       this.help.getCountOfInProgressComplains().subscribe(
        data => this.helpDeskInProgress = data
       
  
      );
      this.help.getCountOfRsolvedComplaints().subscribe(
        data => this.helpDeskResolved = data
       
  
      );
      this.help.getCountOfHoldComplaints().subscribe(
        data => this.heldeskHold = data
       
  
      );
      this.help.getCountOfCancelledComplaints().subscribe(
        data => this.heldeskCancelled = data
